...
// TODO: IsChromiumCookieAccessAllowed() will only be needed while Chromium has
// IsCookieAccessAllowed() around to make sure callers do the right thing for
// in the meantime (see https://crrev.com/c/2855034 for the CL removing that).
